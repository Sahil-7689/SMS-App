...
export default function AdminLogin() {
  ...
  useEffect(() => {
    ...
    const loadCredentials = async () => {
      try {
        const savedRememberMe = await AsyncStorage.getItem('adminRememberMe');
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      <View style={styles.wrapper}>
        ...
        <Text style={styles.subtitle}>
          Access the administrative dashboard to manage application data
        </Text>
        {/* Login Form */}
        <View style={styles.form}>
          ...
          <View style={styles.row}>
            <View style={styles.rememberMeRow}>
              <Switch
                ...
                thumbColor={rememberMe ? "#3b82f6" : "#64748b"}
          ...
          <View style={styles.registerSection}>
            ...
            <TouchableOpacity style={styles.registerButton} onPress={() => router.push('/role/admin-register')}>
